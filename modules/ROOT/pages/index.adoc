...
* **Step 1:** Head over to the **xref:modules/start-here/workflow.adoc[AI-Assisted Design Phase]** to let an LLM generate your course outline from your raw notes.
* **Step 2:** Review the **xref:modules/references/asciidocqrg.adoc[AsciiDoc & Antora Cheat Sheet]** to understand how to structure your repository.
